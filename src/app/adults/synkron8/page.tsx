      ...
      <main>
        ...
        <section className="max-w-[880px] mx-auto px-5 pb-14">
          ...
          <div
            ...
            style={{ boxShadow: 'var(--shadow-blue)' }}
          >
            <Icon icon="mdi:music-note" width={36} className="text-white/80 mb-4" />
            <h2 className="text-[1.25rem] font-[900] text-white leading-[1.15] mb-1">
              Synkron8 Session
            </h2>
            <p className="text-2xl font-[900] text-white mb-3">£15 / session</p>
            <p className="text-sm text-white/80 leading-[1.7] mb-6">
              2 hours. Non-refundable and non-transferable.
            </p>
            <a
              href={LINKS.synkron8}
              target="_blank"
