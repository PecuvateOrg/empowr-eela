...
export const metadata: Metadata = {
  ...
  description:
    'Personalised 1:1 skate coaching with Empowr CIC at The Ladywell Centre — build confidence, improve technique, and work towards your own goals.',
};
    ...
    <>
      ...
      <main>
        ...
        <section className="max-w-[880px] mx-auto px-5 pt-10 pb-8 sm:pt-14 sm:pb-10">
          ...
          >
            Personalised support to build confidence, improve technique, and work towards
            your own skating goals — at your own pace, with a coach&apos;s full attention.
          </p>
        </section>
        ...
        <section className="max-w-[880px] mx-auto px-5 pb-10">
          ...
          <div
            ...
            style={{ boxShadow: 'var(--shadow-blue)' }}
          >
            <Icon icon="mdi:account-tie" width={36} className="text-white/80 mb-4" />
